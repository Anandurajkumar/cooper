...
import bugLogo from "../../assets/images/login-signup/bug_logo.webp";
...
const Register = () => {
  ...
  useEffect(() => {
    if (success) {
      ...
      setTimeout(() => window.onload(window.location.reload(true)), 4000);
    }
  ...
  document.title = "SignUp | Urolime Bug Tracker";
            ...
            <Row>
              <Col lg={12}>
                <div className="text-center mt-sm-5 mb-4 text-white-50">
                  ...
                  >
                    World Class Bug-Tracking Software
                  </p>
                </div>
              </Col>
            </Row>
                  ...
                  <CardBody className="p-4">
                    <div className="text-center mt-2">
                      ...
                      <p className="text-muted">
                        Get your free Bug-Tracker account now
                      </p>
                    </div>
                      ...
                      >
                        {success && success ? (
                          <>
                            ...
                            <Alert color="success">
                              ...
                              Login Page... */}
                              User Registration Successfull. You Will Be
                              Redirected Shortly.
                            </Alert>
                          </>
                        ) : null}
                        ...
                        {error && error ? (
                          <Alert color="danger">
                            <div>
                              {/* {registrationError} */}
                              This Email Has Registered Before, Please Use
                        ...
                        <div className="mb-4">
                          <p className="mb-0 fs-12 text-muted fst-italic">
                            By registering you agree to the Bug-Tracker
                            <Link
                              to="#"
