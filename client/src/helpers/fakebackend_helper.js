...
// Project
export const addProjectList = (project) =>api.create(url.ADD_NEW_PROJECT, project,console.log("project",project));
export const updateProjectList = (project) =>api.update(url.UPDATE_PROJECT, project);
export const deleteProjectList = (project) =>api.delete(url.DELETE_PROJECT+ '/' + project._id);

// get Project list
export const getProjectList = () => api.get(url.BACKEND_PROJECT_LIST);
...
export const postRegister = (data) => api.create(url.POST_USER_REGISTER, data);
...
// export const postProject = (data) => api.create(url.POST_PROJECT, data);
// export const getProject = (data) => api.get(url.GET_PROJECT, data);
// export const updateProject = (data) => api.update(url.UPDATE_PROJECT, data);
// export const deleteProject = (data) => api.delete(url.DELETE_PROJECT, data);
