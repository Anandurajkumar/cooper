...
export const POST_USER_LOGIN="/login_check/login";

//PROJECT//
// Project list
export const GET_PROJECT_LIST = "/project/get";
// Project
export const ADD_NEW_PROJECT = "/project/add_project";
export const UPDATE_PROJECT = "/project/update";
export const DELETE_PROJECT = "/project/delete";

export const BACKEND_PROJECT_LIST="/project/get_project"
...
export const GET_TASK_LIST = "/bug_tracker";
export const ADD_NEW_TASK = "/bug_tracker/add";
export const UPDATE_TASK = "/bug_tracker/update";
export const DELETE_TASK = "/bug_tracker/delete";
